...
### 1. `index_mcp_find_file` -> `ide_find_file`
...
### 2. `index_mcp_get_symbols_overview` -> `ide_file_structure`
...
### 3. `index_mcp_find_symbol` -> `ide_find_symbol`
...
### 4. `index_mcp_find_referencing_symbols` -> `ide_find_references`
...
### 5. `index_mcp_search_for_pattern` -> `ide_search_text`
...
|---|---|---|---|
| `index_mcp_find_file` | `ide_find_file` | PASS / PARTIAL / FAIL | |
| `index_mcp_get_symbols_overview` | `ide_file_structure` | PASS / PARTIAL / FAIL | |
| `index_mcp_find_symbol` | `ide_find_symbol` | PASS / PARTIAL / FAIL | |
| `index_mcp_find_referencing_symbols` | `ide_find_references` | PASS / PARTIAL / FAIL | |
| `index_mcp_search_for_pattern` | `ide_search_text` | PASS / PARTIAL / FAIL | |
